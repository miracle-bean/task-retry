package com.task.retry.mapper.postgre;
 ...
 */
@Mapper
public interface PostgreTaskMapper extends TaskMapper {
    ...
    int hasFail(@Param("businessType") String businessType, @Param("groupId") String groupId);
